...
class SettingsService extends GetxService {
  ...
  ThemeData getLightTheme() {
    ...
    return ThemeData(
        ...
        dividerColor: Ui.secondaryAppColor.withOpacity(0.1),
        //Ui.parseColor(setting.value.accentColor, opacity: 0.1),
        focusColor: Ui.secondaryAppColor,
        //Ui.parseColor(setting.value.accentColor),
        hintColor: Ui.secondaryAppColor,
        //Ui.parseColor(setting.value.secondColor),
        textButtonTheme: TextButtonThemeData(
          style: TextButton.styleFrom(
            foregroundColor: Ui.appColor,
            //Ui.parseColor(setting.value.mainColor),
          ),
        ),
        colorScheme: ColorScheme.light(
          primary: Ui.appColor, //Ui.parseColor(setting.value.mainColor),
          secondary: Ui.appColor, //Ui.parseColor(setting.value.mainColor),
        ),
        textTheme: GoogleFonts.getTextTheme(
          ...
          TextTheme(
            headline6: TextStyle(
                ...
                color: Ui.appColor, //Ui.parseColor(setting.value.mainColor),
                height: 1.3),
            headline5: TextStyle(
                fontSize: 16.0,
                fontWeight: FontWeight.w700,
                color: Ui.secondaryAppColor,
                //Ui.parseColor(setting.value.secondColor),
                height: 1.3),
            headline4: TextStyle(
                fontSize: 18.0,
  ...
  ThemeData getDarkTheme() {
    ...
    return ThemeData(
        ...
        focusColor: Ui.secondaryAppColor,
        //Ui.parseColor(setting.value.accentDarkColor),
        hintColor: Ui.secondaryAppColor,
        //Ui.parseColor(setting.value.secondDarkColor),
        toggleableActiveColor: Ui.appColor,
        //Ui.parseColor(setting.value.mainDarkColor),
        textButtonTheme: TextButtonThemeData(
          style: TextButton.styleFrom(
            foregroundColor:
            Ui.appColor, //Ui.parseColor(setting.value.mainColor)),
          ),
        ),
        colorScheme: ColorScheme.dark(
          primary: Ui.appColor, //Ui.parseColor(setting.value.mainDarkColor),
          secondary: Ui.appColor, //Ui.parseColor(setting.value.mainDarkColor),
        ),
        textTheme: GoogleFonts.getTextTheme(
            _getLocale().startsWith('ar') ? 'Cairo' : 'Poppins',
            TextTheme(
